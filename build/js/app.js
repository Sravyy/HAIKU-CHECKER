...
var HaikuGen = exports.HaikuGen = function () {
  function HaikuGen() {
    _classCallCheck(this, HaikuGen);
  }

  _createClass(HaikuGen, [{
    key: 'GenerateIP',
    value: function GenerateIP() {
      //Generate a random IP address
      var randomip = require('random-ip');
      var ipAddress = randomip('0.0.0.0', 2);
...
},{"hipku":5,"random-ip":12}],2:[function(require,module,exports){
"use strict";
...
},{"syllable":13}],3:[function(require,module,exports){
'use strict'
...
$(document).ready(function () {
  $("button#newHaiku").submit(function (event) {
    ...
    var autoHaiku = new _HaikuGenerator.HaikuGen();
...
$(document).ready(function () {
  $("#formOne").submit(function (event) {
    ...
    var userInput = new _haiku.Haiku(lineOne, lineTwo, lineThree);
    var resultLine = userInput.CheckLines();
    var resultSyllables = userInput.CheckSyllables();

    $("#output").text("Congrats! This is a Haiku.");

    if (resultLine == true && resultSyllables == true) {} else {
      $("#output").text("I am sorry. This is not a proper Haiku. Better luck next time :)");
    }
  });
});

},{"./../js/HaikuGenerator.js":1,"./../js/haiku.js":2}]},{},[15]);
